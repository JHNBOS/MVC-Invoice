...
namespace InvoiceApplication
{
    public class PDF
    {
        ...
        //Create PDF for debtor
        public FileStreamResult CreateDebtorPDF(int invoiceNumber, HttpContext context)
        {
            ...
            string financial = settings.FinancialNumber;
            string euFinancial = settings.EUFinancialNumber;
            string bank = settings.BankName;
            string bankAccount = settings.BankAccountNumber;
            string reg = settings.RegNumber;
            ...
            tf.DrawString("Reg No:", infoFont, XBrushes.Black, new XRect(leftMargin - 24, topMargin + 73, 24, 20), XStringFormats.TopLeft);
            tf.DrawString("Fin. No:", infoFont, XBrushes.Black, new XRect(leftMargin - 9, topMargin + 88, 40, 20), XStringFormats.TopLeft);
            tf.DrawString("EU Fin. No:", infoFont, XBrushes.Black, new XRect(leftMargin - 9, topMargin + 103, 40, 20), XStringFormats.TopLeft);
            tf.DrawString("Web:", infoFont, XBrushes.Black, new XRect(leftMargin + 1, topMargin + 118, 24, 20), XStringFormats.TopLeft);
            ...
            tf.DrawString(reg, infoFont, XBrushes.Black, new XRect(leftMargin + 44, topMargin + 73, 280, 20), XStringFormats.TopLeft);
            tf.DrawString(financial, infoFont, XBrushes.Black, new XRect(leftMargin + 44, topMargin + 88, 280, 20), XStringFormats.TopLeft);
            tf.DrawString(euFinancial, infoFont, XBrushes.Black, new XRect(leftMargin + 44, topMargin + 103, 280, 20), XStringFormats.TopLeft);
            tf.DrawString(web, infoFont, XBrushes.Black, new XRect(leftMargin + 44, topMargin + 118, 280, 20), XStringFormats.TopLeft);
        ...
        public FileStreamResult CreateCompanyPDF(int invoiceNumber, HttpContext context)
        {
            Invoice selected = null;
            List<InvoiceItem> itemList = null;
            List<Product> productList = new List<Product>();
            ...
            try
            {
                selected = _context.Invoices.Single(p => p.InvoiceNumber == invoiceNumber);
                itemList = _context.InvoiceItems.Where(i => i.InvoiceNumber == selected.InvoiceNumber).ToList();
                Company = _context.Companies.Single(d => d.CompanyID == selected.CompanyID);
            ...
            string cCity = Company.PostalCode + " " + Company.City;
            string cCountry = Company.Country;
            string cName = Company.CompanyName;
            ...
            tf.DrawString(cName, textFont, XBrushes.Black, new XRect(rightMargin - 40, topMargin + 150, 160, 20), XStringFormats.TopLeft);
            tf.DrawString(cAddress, textFont, XBrushes.Black, new XRect(rightMargin - 40, topMargin + 165, 200, 20), XStringFormats.TopLeft);
            tf.DrawString(cCity, textFont, XBrushes.Black, new XRect(rightMargin - 40, topMargin + 180, 200, 20), XStringFormats.TopLeft);
            tf.DrawString(cCountry, textFont, XBrushes.Black, new XRect(rightMargin - 40, topMargin + 195, 200, 20), XStringFormats.TopLeft);
